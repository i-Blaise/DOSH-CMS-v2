            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('hsp-store') }}" class="forms-sample">
                        ...
                        <input type="text" name="hospital_name" class="form-control" id="hospital_name" placeholder="Enter hospital name" required>
                        </div>
                        ...
                        <div class="form-group" id="region-group">
                            ...
                            <input type="text" id="region-text" name="region_name" class="form-control" placeholder="Enter Region">
                        </div>
                        ...
                        <input type="text" name="phone_number1" class="form-control" id="phone_number1">
                        </div>

                        <div class="form-group">
                        <label for="phone_number2">Phone Number 2</label>
                        <input type="text" name="phone_number2" class="form-control" id="phone_number2">
                        </div>

                        <div class="form-group">
                        <label for="phone_number3">Phone Number 3</label>
                        <input type="text" name="phone_number3" class="form-control" id="phone_number3">
                        </div>
                        ...
                        <input type="text" name="location_address" class="form-control" id="location_address" placeholder="Auto-generated if left empty">
                        </div>
